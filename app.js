    ...
    getProfiles: () => ({
        ...
        'staff': {
            ...
            sections: [
                ...
                { title: '🎯 2. Abordagem Estratégica', items: ['<strong>⏳ 1. Tempo:</strong> "E aí mano, tu já tá há mó cota aqui na cidade né?"', '<strong>🏢 2. Situação:</strong> "Já tem tua galera aí? Já tá estruturado?"', '<strong>📍 3. Posicionamento:</strong> "Mas a galera te reconhece fácil? Tipo, só de bater o olho já sabem que é você?" ➔ <em>Objetivo: Abrir a dor.</em>'] },
        ...
        const database = {
            'olheiro': {
                ...
                sections: [
                    ...
                    { title: "🚶‍♂️ Comportamento do Cliente", items: ["🗺️ Está perdido?", "👣 Está andando sem rumo?", "🛠️ Está testando coisas?", "🧍‍♂️ Está parado?"], footer: "💡 Normalmente, clientes em momento tranquilo têm mais chance de dar atenção." },
