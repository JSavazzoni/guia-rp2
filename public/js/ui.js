    ...
    templates: {
        auth: () => `
            <style>
                ...
                /* DESFOQUE REDUZIDO PARA 4px */
                .overlayContainer { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: radial-gradient(circle at center, rgba(10,10,10,0.6) 0%, rgba(0,0,0,0.9) 100%); backdrop-filter: blur(4px); z-index: 2; }
        ...
        admin: () => `
            <style>
                ...
                .bgContainer { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-image: url('AssetStore/image_1e6304.jpg'); background-size: cover; background-position: center; z-index: 1; opacity: 0.35; }
                /* DESFOQUE REDUZIDO PARA 4px */
                .overlayContainer { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(0,0,0,0.85); backdrop-filter: blur(4px); z-index: 2; }
            ...
            return `
                <style>
                    ...
                    * { box-sizing: border-box; scrollbar-width: thin; scrollbar-color: rgba(212, 175, 55, 0.3) transparent; }
                    ...
                    /* IMAGENS AUMENTADAS PARA 420x240 */
                    .headerImgBox { width: 420px; height: 240px; flex-shrink: 0; border: 2px solid rgba(212, 175, 55, 0.5); border-radius: 12px; overflow: hidden; box-shadow: 0 15px 30px rgba(0,0,0,0.8); background: #000; padding: 0; }
